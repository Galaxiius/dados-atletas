# Projeto 2 - Dados do atleta

#### Segundo projeto da conclusão do módulo de JavaScript do curso DevStart do Senai. Com o intuito de praticar o que foi aprendido no decorrer do curso, foi elaborado este projeto. Assuntos praticados:

 - o conceito de classe e sua criação, 
 - propriedades, 
 - if/else, 
 - declarações,
 - chamadas de funções,
